...
class Game(object):
    def __init__(self):
        ...
        # Create the player
        self.player = Player(32,128,"Pacman/player.png")
        ...
        self.pacman_sound = pygame.mixer.Sound("Pacman/pacman_sound.ogg")
        self.game_over_sound = pygame.mixer.Sound("Pacman/game_over_sound.ogg")
